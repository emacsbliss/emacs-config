...
(setq +notes-dir (expand-file-name "~/org/roam"))
...
#+begin_quote
However, if you capture a note while your cursor is on the same line of an agenda entry, the content will be filled with this entry. This is super convenient to link your note with the agenda entry. [fn:12]
#+end_quote
