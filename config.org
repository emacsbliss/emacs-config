...
#+BEGIN_SRC emacs-lisp
(package! another-package :tangle no
...
~:files~ in the ~:recipe~:
#+BEGIN_SRC emacs-lisp
(package! this-package :tangle no
  :recipe (:host github :repo "username/repo"
...
(map! :leader
  ...
  (:when (featurep! :tools upload)
    (:prefix-map ("r" . "remote")
      ...
      :desc "org roam yesterday"         "T" #'org-roam-yesterday
...
#+BEGIN_SRC emacs-lisp :tangle no
(setq sdcv-dictionary-data-dir "~/dict")
#+END_SRC
...
This setting will try suggesting dired targets:
#+BEGIN_SRC emacs-lisp
...
(use-package org-roam
      ...
      :custom
      (org-roam-directory "~/org/roam/org")
...
#+END_SRC
** multiple org-roam
I also want to use org-roam for other things in my life other than knowledge
management, so I wrote this little function to help with that.

#+BEGIN_SRC emacs-lisp
(defvar org-roam-directories-alist nil)
(setq org-roam-directories-alist '(("default" . "~/org/roam/org")
                                   ("life" . "~/repo/life")))
#+END_SRC
...
"choose between all org roam directories"
  ...
  (ivy-read "options: " org-roam-directories-alist
            :action '(1
                      ("o" (lambda (x) (setq org-roam-directory (cdr x))) "select")))
)
#+END_SRC
...
(map! :map wl-summary-mode-map
  ...
  :desc "mark current"        :n "m"     #'wl-summary-target-mark-line
...
for xml/xsd file.
#+begin_src emacs-lisp :tangle modules/lang/xml/autoload.el
(setq auto-mode-alist (delete '("\\.x[ms]l\\'" . xml-mode) auto-mode-alist))
...
(use-package! notdeft
  ...
  (setq notdeft-directories '("~/org/roam/org" "~/org/roam/org/.attach"))
