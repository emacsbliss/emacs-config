...
** snails - experimenting
update on <2021-01-23 Sat>:
...
(use-package! snails
  :init
  (evil-set-initial-state 'snails-mode-map 'insert)
...
(map! :map snails-mode-map
  :desc "show bookmkar" :in "C-j" #'snails-select-next-item
  :desc "show bookmkar" :in "C-k" #'snails-select-prev-item
  :desc "show bookmkar" :in "C-g" #'snails-kill)
#+end_src
** lentic - disabled
